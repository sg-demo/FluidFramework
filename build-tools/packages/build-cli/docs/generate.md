...
DESCRIPTION
  Compare the PR's locally-collected bundle reports against the baseline CI build and write a structured result to disk.
  The output is consumed by the GitHub Actions workflow that posts the PR comment.
```
